...
export default {
	...
	theme: {
		...
		extend: {
			colors: {
				...
				primary: {
					DEFAULT: '#4567b7', // Cool Blue
					foreground: 'hsl(var(--primary-foreground))'
				},
				secondary: {
					DEFAULT: '#f7f7f7', // Neutral
					foreground: 'hsl(var(--secondary-foreground))'
				},
				accent: {
					DEFAULT: '#04f8e0', // Turquoise
			...
			backgroundImage: {
				...
				'hero-pattern': 'linear-gradient(to right bottom, rgba(69, 103, 183, 0.8), rgba(4, 248, 224, 0.8))',
    ...
    require('@tailwindcss/typography') // Ensure this plugin is registered
  ],
} satisfies Config;
